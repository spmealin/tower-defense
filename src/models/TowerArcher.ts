...
export class TowerArcher extends Building {
    ...
    constructor(game: Game, position: Position) {
        ...
        for (
            ...
            for (
                ...
                if (
                    Math.abs(i) <= this._nonRange ||
                    Math.abs(j) <= this._nonRange
                ) {
                    continue;
                }
     ...
     */
    private _handleAttackEvent = (event: AttackEvent<TowerArcher>) => {
